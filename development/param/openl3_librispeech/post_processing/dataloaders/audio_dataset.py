...
class AudioDataset(Dataset):
    ...
    def __init__(self, root_dir, transform=None, num_audios = -1, num_frames = -1, return_amp = True, emb_means = None, emb_stds = None, spec_means = None, spec_stds = None, quantized_folder = None):
        
        self.root_dir = root_dir
        if quantized_folder is None:
            self.embeddings_dir = os.path.join(self.root_dir, 'embeddings_6144')
        else:
            self.embeddings_dir = os.path.join(self.root_dir, quantized_folder)
